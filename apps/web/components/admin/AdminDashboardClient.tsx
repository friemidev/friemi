                  ...
                  <FormField label="活动类型">
                    <select
                      ...
                      onChange={(e) =>
                        setActivityForm({
                          ...activityForm,
                          type: e.target.value as ActivityFormState["type"],
                        })
                      }
                    >
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setActivityForm({
                          ...activityForm,
                          category: e.target
                            .value as ActivityFormState["category"],
                        })
                      }
                    >
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setActivityForm({
                          ...activityForm,
                          priceType: e.target
                            .value as ActivityFormState["priceType"],
                        })
                      }
                    >
                  ...
                  <FormField label="活动状态">
                    <select
                      ...
                      onChange={(e) =>
                        setActivityForm({
                          ...activityForm,
                          status: e.target.value as ActivityFormState["status"],
                        })
                      }
                    >
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setActivityForm({
                          ...activityForm,
                          visibility: e.target
                            .value as ActivityFormState["visibility"],
                        })
                      }
                    >

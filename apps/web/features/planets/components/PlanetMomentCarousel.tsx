    ...
    <div className="rounded-[1.75rem] bg-[#fffefa] p-2 shadow-[0_18px_42px_rgba(54,47,35,0.12)] ring-1 ring-[#e7e0d5]">
      ...
      <div className="mt-3 flex items-center justify-between gap-3 px-2 pb-1">
        <div className="min-w-0">
          <p className="truncate text-base font-bold text-[#1f211e]">{content || "精彩瞬间"}</p>
        ...
        <form action={togglePlanetMomentLikeAction} className="shrink-0">
          ...
          <button
            aria-label="点赞"
            className={`inline-flex h-10 min-w-10 items-center justify-center gap-1 rounded-full border border-[#eadfd4] bg-white px-3 text-sm font-bold shadow-sm ${isLiked ? "text-[#ba4439]" : "text-[#1f211e]"}`}
          >

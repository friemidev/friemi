      ...
      {manualCopyOpen ? (
        ...
        >
          ...
          <div className="relative w-full max-w-md rounded-2xl border border-[#bfd6b7] bg-[#fffaf2] p-4 shadow-2xl">
            ...
            <textarea
              autoFocus
              className="mt-3 max-h-44 min-h-24 w-full resize-none rounded-xl border border-[#bfd6b7] bg-white p-3 text-sm leading-6 text-zinc-800 outline-none focus:ring-2 focus:ring-[#049d73]/25"

  ...
  if (!src || hasFailed) {
    return (
      <div
        ...
        aria-hidden="true"
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_28%_18%,rgba(54,151,88,0.16),transparent_34%),radial-gradient(circle_at_78%_84%,rgba(240,145,130,0.13),transparent_30%),linear-gradient(135deg,rgba(254,255,249,0.95),rgba(241,242,227,0.92))]" />
        ...
        <div className="relative flex h-14 w-14 items-center justify-center overflow-hidden rounded-2xl border border-[#8AB68E] bg-[#FEFFF9] shadow-[0_16px_36px_rgba(21,98,64,0.12)] sm:h-16 sm:w-16">
          {/* Full-background logo is safer on image fallback surfaces. */}

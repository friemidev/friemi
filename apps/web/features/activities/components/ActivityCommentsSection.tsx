...
export function ActivityCommentsSection({
  ...
  return (
    <section
      className="rounded-lg border border-[#D6D5B2] bg-white/75 p-4 sm:p-5"
      id="comments"
    >
      ...
      <div className="mt-5 border-t border-[#D6D5B2] pt-5">
        {isAuthenticated ? (
          <ActivityCommentForm activityId={activityId} locale={locale} />
        ) : (
          <div className="rounded-xl border border-[#D6D5B2] bg-[#FEFFF9]/72 p-3 text-sm">
      ...
      <div className="mt-6 divide-y divide-[#D6D5B2]/80">
        {comments.length > 0 ? (
          ...
          <div className="rounded-md border border-dashed border-[#8AB68E] bg-[#FEFFF9]/60 p-5 text-center">

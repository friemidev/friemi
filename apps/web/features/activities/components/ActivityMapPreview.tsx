...
export function ActivityMapPreview({
  ...
  return (
    <div
      className={
        className
          ? `overflow-hidden rounded-lg border border-[#cfe2c6] bg-white ${className}`
          : "overflow-hidden rounded-lg border border-[#cfe2c6] bg-white"
      }
    >
      <div className="flex items-start justify-between gap-3 px-4 py-3">
        ...
        <a
          className="inline-flex h-8 shrink-0 items-center justify-center gap-1 whitespace-nowrap rounded-md bg-white px-2.5 text-xs font-medium text-ink ring-1 ring-[#cfe2c6] transition hover:bg-[#f7fff3]"
          href={googleMapsUrl}
          target="_blank"
          rel="noreferrer"
        >
      ...
      {embedUrl ? (
        ...
        <div className="border-t border-[#cfe2c6] bg-[#f7fff3] px-4 py-6 text-center text-sm leading-6 text-zinc-600">

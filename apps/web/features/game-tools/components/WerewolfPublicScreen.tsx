      ...
      <div className="grid min-h-[calc(100svh-6rem)] gap-6 p-5 lg:grid-cols-[minmax(0,1fr)_21rem] lg:p-8">
        <div className="grid content-between gap-6">
          <header className="grid gap-5 pl-14 xl:grid-cols-[minmax(0,1fr)_32rem] xl:items-start">
            <div className="min-w-0">
              ...
              <h1 className="mt-3 max-w-5xl text-4xl font-bold leading-[1.02] tracking-normal text-[#1E1718] md:text-6xl">
                {room.title}
              </h1>
              <p className="mt-3 text-lg font-bold text-[#7A1F2B]">
                {statusLabel}
              </p>
            </div>
        ...
        <aside className="grid content-between gap-5">
          ...
          <div className="rounded-[1.5rem] border border-[#D9C7B4] bg-white p-4 shadow-sm">
            <h2 className="inline-flex items-center gap-2 text-sm font-bold text-[#1E1718]">
            ...
            <div className="mt-3 grid gap-2">
              {room.events.slice(0, 5).map((event) => (
                <div
                  className="flex items-center justify-between gap-3 rounded-2xl bg-[#F7F3EC] px-3 py-2 text-xs font-bold text-[#7A1F2B]"
                  key={event.id}
                >
  ...
  return (
    ...
    >
      <img
        ...
        src={iconSrc}
      />
      <p className="text-2xl font-bold leading-none text-[#1E1718]">{value}</p>

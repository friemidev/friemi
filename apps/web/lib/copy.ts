...
const copy = {
  "zh-CN": {
    ...
    accountMenu: {
      ...
      analyticsOps: "数据后台",
      analyticsOpsDescription: "查看运营指标和来源价值",
      activityOps: "活动运营",
    ...
    activityDetail: {
      ...
      hiddenOnlineLinkNotice: "报名后显示链接。",
      hiddenOnlineLinkApprovalNotice: "审核通过后显示链接。",
      onlineLink: "线上链接",
      onlineLinkFallback: "链接暂未填写",
      openMap: "打开地图",
    ...
    activityShare: {
      ...
      teamDescription: "复制组局邀请，下载带二维码的宣传图。",
      expand: "展开分享工具",
      collapse: "收起分享工具",
      copyTitle: "复制标题",
      copyTime: "复制时间",
      ...
      qrDownloadFailed: "二维码生成失败，请稍后重试。",
      posterTime: "时间",
      posterLocation: "地点",
      posterPrice: "费用",
    ...
    activityComments: {
      ...
      savingEdit: "保存中...",
      delete: "删除",
      deleteConfirm: "删除后内容会隐藏，已有回复仍会保留。",
      confirmDelete: "确认删除",
      deleting: "删除中...",
      cancel: "取消",
      edited: "已编辑",
      ...
      commentUnavailable: "这条评论不存在或不可操作。",
    ...
    translation: {
      translate: "翻译",
      translateMainInfo: "翻译主要信息",
      translating: "翻译中...",
      showOriginal: "查看原文",
      showTranslation: "查看翻译",
      translatedBy: "DeepL 翻译",
      failed: "暂时无法翻译，请稍后重试。",
      fields: {
        title: "标题",
        description: "介绍",
    ...
    weather: {
      title: "出行天气",
      loading: "正在查看活动地天气...",
      unavailable: "暂时无法获取活动地天气。",
      locationFallback: "活动地点",
      rain: "降雨",
      wind: "风速",
      conditions: {
        clear: "晴",
    ...
    profile: {
      ...
      editWechat: "修改微信号",
      wechatBound: "微信号已绑定",
      wechatUnbound: "微信号未绑定",
      wechatLabel: "微信号",
      wechatPlaceholder: "填写微信号，方便找回游客报名",
  ...
  en: {
    ...
    accountMenu: {
      ...
      analyticsOpsDescription: "Review operations and source value",
    ...
    activityDetail: {
      ...
      hiddenAddressNotice: "Exact address shown after joining.",
      hiddenAddressApprovalNotice: "Exact address shown after approval.",
      hiddenOnlineLinkNotice: "Link shown after joining.",
      hiddenOnlineLinkApprovalNotice: "Link shown after approval.",
      onlineLink: "Online link",
      onlineLinkFallback: "Link not added yet",
      openMap: "Open map",
    ...
    activityShare: {
      ...
      qrDownloadFailed: "QR code generation failed. Try again later.",
      posterTime: "Time",
    ...
    activityComments: {
      ...
      delete: "Delete",
      deleteConfirm:
        "This hides the comment content. Existing replies will stay visible.",
      ...
      commentUnavailable: "This comment is unavailable.",
    ...
    translation: {
      translate: "Translate",
      translateMainInfo: "Translate key info",
      translating: "Translating...",
      showOriginal: "View original",
      showTranslation: "View translation",
      translatedBy: "Translated by DeepL",
      failed: "Translation is unavailable right now. Try again later.",
      fields: {
        title: "Title",
    ...
    weather: {
      title: "Weather",
      loading: "Checking the weather there...",
      unavailable: "Weather for this activity is unavailable.",
      locationFallback: "Activity location",
      rain: "Rain",
      wind: "Wind",
      conditions: {
        clear: "Clear",
    ...
    profile: {
      ...
      wechatBound: "WeChat ID connected",
      wechatUnbound: "WeChat ID not connected",
      wechatLabel: "WeChat ID",
      wechatPlaceholder: "Add WeChat ID to link guest signups",
      wechatDialogDescription:
        "Your WeChat ID is only used to link guest signups back to this account.",
      wechatPrivacyHint:
        "Your WeChat ID is not shown on event pages, crew pages, participant lists, or public pages. Save an empty value to disconnect it.",
      saveWechat: "Save WeChat",
      savingWechat: "Saving...",
    ...
    form: {
      ...
      linkImportDescription:
        "If you already have an activity page, parse the link first and apply useful details to this plan.",
      ...
      capacityLimitHint:
        "By default there is no participant limit. Turn this on when seats need to be controlled.",
      capacity: "Crew size",
      capacityPlaceholder: "Example: 8",
  ...
  fr: {
    ...
    accountMenu: {
      ...
      analyticsOps: "Tableau de bord",
      analyticsOpsDescription: "Suivre les indicateurs et sources",
    ...
    activityDetail: {
      ...
      onlineLinkFallback: "Lien pas encore ajouté",
    ...
    activityShare: {
      ...
      qrDownloadFailed: "Échec de génération du QR code. Réessayez plus tard.",
      posterTime: "Heure",
      posterLocation: "Lieu",
      posterPrice: "Coût",
    ...
    activityComments: {
      ...
      delete: "Supprimer",
      deleteConfirm:
        "Le contenu sera masqué. Les réponses existantes resteront visibles.",
      ...
      commentUnavailable: "Ce commentaire n'est pas disponible.",
    ...
    translation: {
      translate: "Traduire",
      translateMainInfo: "Traduire les infos clés",
      translating: "Traduction...",
      showOriginal: "Voir l'original",
      showTranslation: "Voir la traduction",
      translatedBy: "Traduit avec DeepL",
      failed: "Traduction indisponible pour le moment. Réessayez plus tard.",
      fields: {
        title: "Titre",
        description: "Description",
        address: "Lieu",
    ...
    weather: {
      title: "Météo",
      loading: "Chargement de la météo sur place...",
      unavailable: "La météo de cette activité est indisponible.",
      locationFallback: "Lieu de l'activité",
      rain: "Pluie",
      wind: "Vent",
      conditions: {
        clear: "Ciel dégagé",
    ...
    profile: {
      ...
      bindWechat: "Lier WeChat",
      editWechat: "Modifier WeChat",
      wechatBound: "WeChat lié",
      wechatUnbound: "WeChat non lié",
      wechatLabel: "WeChat",
      wechatPlaceholder: "Ajoutez votre WeChat pour relier vos inscriptions",
      wechatDialogDescription:
        "Votre WeChat sert uniquement à relier vos inscriptions invité à ce compte.",
      wechatPrivacyHint:
        "Votre WeChat n'est pas affiché sur les activités, les équipes, les listes de participants ni les pages publiques. Enregistrez une valeur vide pour le délier.",
    ...
    form: {
      ...
      activityContent: "Comment vous voulez vous organiser",
      ...
      linkImportDescription:
        "Si vous avez déjà une page d'activité, analysez le lien puis appliquez les informations utiles à cette sortie.",
      ...
      description: "Message de sortie",
      descriptionPlaceholder:
        "Expliquez le rendez-vous, l'ambiance et les points utiles",
      itinerary: "Organisation du rendez-vous",
      itineraryPlaceholder:
        "18:30 Rendez-vous\n19:00 Entrée ou début ensemble\n21:30 Discussion libre",
      type: "Format de sortie",
      typeHint:
        "Choisissez sortie locale ou compagnon de voyage. Cela influence l'étiquette.",
      category: "Thème de sortie",
      categoryHint:
      ...
      otherCategoryHint:
        "Enregistré dans le message pour aider les participants à comprendre.",
      ...
      capacityLimitHint:
        "Par défaut, il n'y a pas de limite. Activez cette option si les places doivent être contrôlées.",
      capacity: "Taille du groupe",
      capacityPlaceholder: "Exemple : 8",

...
const copy = {
  "zh-CN": {
    ...
    profile: {
      ...
      wechatHint: "如果你用同一个微信号游客报名过，保存后会自动关联到当前账号。",
      createdCount: "发起组局",
  ...
  en: {
    ...
    profile: {
      ...
      wechatHint:
        "Guest signups using the same WeChat ID will be linked to this account after saving.",
  ...
  fr: {
    ...
    profile: {
      ...
      wechatHint:
        "Les inscriptions invite avec le meme WeChat seront reliees a ce compte apres enregistrement.",
      createdCount: "Créées",

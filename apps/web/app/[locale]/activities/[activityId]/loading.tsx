...
export default function ActivityDetailLoading() {
  return (
    <LoadingPageShell className="space-y-6">
      <div className="relative flex min-h-52 items-end overflow-hidden rounded-[1.25rem] border border-black/10 bg-[#F1F2EC] p-4 shadow-[0_16px_36px_rgba(29,29,27,0.08)] sm:p-5 md:min-h-72">

  ...
  return (
    <LoadingPageShell className="space-y-5 py-5 sm:space-y-6 sm:py-8">
      <section className="space-y-3">
        ...
        <div className="rounded-[1.25rem] bg-white/62 p-3 shadow-sm ring-1 ring-[#bfd6b7] md:hidden">
        ...
        <div className="hidden rounded-[1.25rem] bg-white/62 p-3 shadow-sm ring-1 ring-[#bfd6b7] md:block">

  ...
  return (
    <PageContainer className="max-w-6xl space-y-5 py-4 sm:space-y-6 sm:py-8">
      ...
      <section className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_340px] lg:items-start">
        <aside className="min-w-0 rounded-[1.25rem] border border-[#cfe2c6] bg-white/80 p-4 shadow-sm lg:sticky lg:top-24 lg:order-2">
          ...
          <div className="mt-4 grid gap-3 text-sm text-zinc-600">
            ...
            <span className="grid grid-cols-[auto_minmax(0,1fr)] items-start gap-2">
              <Ticket className="mt-0.5 h-4 w-4 shrink-0 text-[#006e4d]" />
              <span className="min-w-0 break-words">
                {getEventPriceLabel(publicEvent, locale)}
              </span>
            </span>
          </div>
          <div className="mt-4 rounded-2xl bg-[#f7fff3] px-3 py-3 text-sm leading-6 text-zinc-600 ring-1 ring-[#bfd6b7]">

...
export default function MessagesLoading() {
  return (
    ...
    >
      <section className="min-h-[30rem] overflow-hidden rounded-[1.45rem] border border-sand bg-white/70 shadow-[0_18px_48px_rgba(10,63,49,0.08)] ring-1 ring-white/70">
        <div className="flex items-center gap-3 border-b border-sand bg-[linear-gradient(135deg,#f7fff3_0%,#fffaf2_62%,#fff0ed_100%)] p-4">
      ...
      <aside className="space-y-3 rounded-[1.45rem] border border-sand bg-white/65 p-4 shadow-[0_18px_48px_rgba(10,63,49,0.08)] ring-1 ring-white/70">

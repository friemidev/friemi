...
function getCopy(locale: string) {
  ...
  return {
    ...
    activityInfo: "活动",
    activityInfoDescription: "公共活动是否真的促成聚吧。",
    activityRankActivity: "聚吧",
    ...
    description:
      "给运营和管理员快速判断：用户是否发现活动、是否发起聚吧、报名沟通是否顺畅、来源是否值得维护。",
    environment: "环境",
    ...
    publicEventSourcesDescription: "对比来源的导入量、点击量和转聚吧结果。",
    qr: "二维码",
    reportActivity: "聚吧",
    reportComment: "评论",
    reportMoment: "足迹",
    ...
    sourceSurfaceDescription: "用户从哪里进入聚吧详情。",
    subtitle: "数据后台",
    title: "运营数据看台",
    topDecision: "运营总览",
    totalSamples: "记录样本",
    ...
    trendTeam: "聚吧",
    trendTitle: "使用趋势",
    trendDescription: "快速观察发现、聚吧、报名和沟通在不同日期的变化。",
    viewCount: "浏览",
    clickCount: "点击",
    openRate: "打开率",
  };
...
function getFocusCopy(locale: string) {
  ...
  return {
    ...
    joinBody: "聚吧详情有人看，但报名转化偏弱。",
    joinTitle: "关注报名转化",
    noIntentBody: "优先观察发起聚吧、报名、评论、联系和私聊。",
    noIntentTitle: "互动正在积累",
    noSourcesBody: "导入已经就绪，后续点击和聚吧数据会帮助判断来源价值。",
    noSourcesTitle: "来源价值待观察",
    publicEventBody: "活动有人看，但转成聚吧还不明显。",
    publicEventTitle: "关注聚吧发起",

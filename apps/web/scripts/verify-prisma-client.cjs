...
const requiredFields = [
  ...
  ["Planet", "chatReadStates"],
  ["UserProfile", "planetChatReadStates"],
  ["PlanetChatReadState", "lastReadAt"],
  ["PlanetChatReadState", "mutedAt"],
  ["PlanetChatReadState", "pinnedAt"],
  ["PlanetMessage", "mentionedProfileIds"],
  ["PlanetMessage", "mentionLabels"],
  ["PlanetMessage", "mentionsEveryone"],
  ["PlanetMoment", "likes"],
  ["PlanetMomentComment", "likes"],
  ["Activity", "roomReadStates"],
  ["UserProfile", "activityRoomReadStates"],
  ["ActivityRoomReadState", "lastReadAt"],
  ["ActivityRoomMessage", "mentionedProfileIds"],
  ["ActivityRoomMessage", "mentionLabels"],
  ["ActivityRoomMessage", "mentionsEveryone"],
